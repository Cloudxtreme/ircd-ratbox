...
#ifdef ENABLE_FAKE_CLIENTS
extern int h_client_connect_id;
extern int h_fake_kill_id;
extern int h_fake_skill_id;
extern int h_fake_squit_id;
extern int h_fake_message_id;
extern int h_fake_collision_id;
#endif
#endif
