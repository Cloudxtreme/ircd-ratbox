...
int h_client_connect_id;
int h_fake_kill_id;
int h_fake_skill_id;
int h_fake_message_id;
int h_fake_squit_id;
int h_fake_collision_id;
#endif
...
#ifdef ENABLE_FAKE_CLIENTS
	hook_add_event("client_connect", &h_client_connect_id);
	hook_add_event("fake_kill", &h_fake_kill_id);
	hook_add_event("fake_skill", &h_fake_skill_id);
	hook_add_event("fake_message", &h_fake_message_id);
	hook_add_event("fake_squit", &h_fake_squit_id);
	hook_add_event("fake_collision", &h_fake_collision_id);
#endif
}
