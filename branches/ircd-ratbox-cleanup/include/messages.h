...
#define NUMERIC_STR_250	":Highest connection count: %lu (%lu clients) (%lu connections received)"
#define NUMERIC_STR_251	":There are %lu users and %lu invisible on %lu servers"
#define NUMERIC_STR_252	"%lu :IRC Operators online"
#define NUMERIC_STR_253	"%lu :unknown connection(s)"
#define NUMERIC_STR_254	"%lu :channels formed"
#define NUMERIC_STR_255	":I have %lu clients and %lu servers"
...
#define NUMERIC_STR_265	"%lu %lu :Current local users %lu, max %lu"
#define NUMERIC_STR_266	"%lu %lu :Current global users %lu, max %lu"
...
#define NUMERIC_STR_317	"%s " RBTT_PFX "u" RBTT_PFX "u :seconds idle, signon time"
