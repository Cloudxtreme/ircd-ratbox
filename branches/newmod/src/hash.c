 ...
 */
void
add_to_id_hash(const char *name, struct rpi_client *client_p)
{
	unsigned int hashv;
 ...
 */
void
add_to_client_hash(const char *name, struct rpi_client *client_p)
{
	unsigned int hashv;
 ...
 */
void
add_to_hostname_hash(const char *hostname, struct rpi_client *client_p)
{
	unsigned int hashv;
 ...
 */
void
del_from_id_hash(const char *id, struct rpi_client *client_p)
{
	unsigned int hashv;
	dlink_node *ptr;
	dlink_node *next_ptr;
 ...
 */
void
del_from_client_hash(const char *name, struct rpi_client *client_p)
{
	unsigned int hashv;
	dlink_node *ptr;
	dlink_node *next_ptr;
 ...
 */
void
del_from_hostname_hash(const char *hostname, struct rpi_client *client_p)
{
	unsigned int hashv;
...
hash_find_masked_server(struct rpi_client *source_p, const char *name)
{
	char buf[HOSTLEN + 1];
	char *p = buf;
	char *s;
	struct rpi_client *server;
 ...
 */
struct rpi_client *
find_server(struct rpi_client *source_p, const char *name)
{
	struct rpi_client *target_p;
	dlink_node *ptr;
	unsigned int hashv;
 ...
 */
struct Channel *
get_or_create_channel(struct rpi_client *client_p, const char *chname, int *isnew)
{
	struct Channel *chptr;
	dlink_node *ptr;
	unsigned int hashv;
...
void
print_resv_hash(struct rpi_client *source_p)
{
	struct ConfItem *aconf;
	dlink_node *ptr;
	int i;
...
static void
output_hash(struct rpi_client *source_p, const char *name, int length, int *counts, int deepest)
{
...
static void
count_hash(struct rpi_client *source_p, dlink_list *table, int length, const char *name)
{
	int counts[11];
	int deepest = 0;
	int i;
...
void
hash_stats(struct rpi_client *source_p)
{
