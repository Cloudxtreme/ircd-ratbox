 ...
 * show_iline_prefix()
 *
 * inputs       - pointer to struct rpi_client requesting output
 ...
 */
char *
show_iline_prefix(struct rpi_client *sptr, struct ConfItem *aconf, char *name)
{
 ...
 */
void
report_auth(struct rpi_client *client_p)
{
 ...
 */
void
report_Klines(struct rpi_client *source_p)
{
