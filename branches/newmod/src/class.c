 ...
 */
const char *
get_client_class(struct rpi_client *target_p)
{
 ...
 */
int
get_client_ping(struct rpi_client *target_p)
{
	int ping = 0;
 ...
 */
void
report_classes(struct rpi_client *source_p)
{
	struct Class *cltmp;
	dlink_node *ptr;
 ...
 */
long
get_sendq(struct rpi_client *client_p)
{
