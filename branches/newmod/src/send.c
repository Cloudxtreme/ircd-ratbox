 ...
 */
static int
_send_linebuf(struct rpi_client *to, buf_head_t *linebuf)
{
	if(IsMe(to))
	{
 ...
 */
static void
send_linebuf_remote(struct rpi_client *to, struct rpi_client *from, buf_head_t *linebuf)
{
	if(to->from)
		to = to->from;
 ...
 */
void
sendto_one(struct rpi_client *target_p, const char *pattern, ...)
{
	va_list args;
	buf_head_t linebuf;
 ...
 */
void
sendto_one_prefix(struct rpi_client *target_p, struct rpi_client *source_p,
		  const char *command, const char *pattern, ...)
{
	struct rpi_client *dest_p;
	va_list args;
	buf_head_t linebuf;
 ...
 */
void
sendto_one_notice(struct rpi_client *target_p, const char *pattern, ...)
{
	struct rpi_client *dest_p;
	va_list args;
	buf_head_t linebuf;
 ...
 */
void
sendto_one_numeric(struct rpi_client *target_p, int numeric, const char *pattern, ...)
{
	struct rpi_client *dest_p;
	va_list args;
	buf_head_t linebuf;
 ...
 */
void
sendto_server(struct rpi_client *one, struct Channel *chptr, unsigned long caps,
 ...
 */
void
sendto_channel_flags(struct rpi_client *one, int type, struct rpi_client *source_p,
 ...
 */
void
sendto_common_channels_local(struct rpi_client *user, const char *pattern, ...)
{
	va_list args;
	dlink_node *ptr;
	dlink_node *next_ptr;
 ...
 */
void
sendto_match_butone(struct rpi_client *one, struct rpi_client *source_p,
 ...
 */
void
sendto_match_servs(struct rpi_client *source_p, const char *mask, int cap,
 ...
 */
void
sendto_anywhere(struct rpi_client *target_p, struct rpi_client *source_p,
		const char *command, const char *pattern, ...)
{
	va_list args;
	buf_head_t linebuf;
 ...
 */
void
sendto_wallops_flags(int flags, struct rpi_client *source_p, const char *pattern, ...)
{
	struct rpi_client *client_p;
	dlink_node *ptr;
	dlink_node *next_ptr;
 ...
 */
void
kill_client(struct rpi_client *target_p, struct rpi_client *diedie, const char *pattern, ...)
{
	va_list args;
	buf_head_t linebuf;
 ...
 */
void
kill_client_serv_butone(struct rpi_client *one, struct rpi_client *target_p, const char *pattern, ...)
{
	va_list args;
	struct rpi_client *client_p;
	dlink_node *ptr;
