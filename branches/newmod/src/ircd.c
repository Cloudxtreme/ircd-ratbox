...
struct rpi_client *me;		/* That's me */
struct rpi_localclient melocalclient;	/* That's also part of me */
...
main(int argc, char *argv[])
{
	...
	me = malloc(sizeof(rpi_client));
	memset(me, 0, sizeof(me));
	memset(&melocalclient, 0, sizeof(melocalclient));
	me->localClient = &melocalclient;
