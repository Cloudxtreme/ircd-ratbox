...
static void report_and_set_user_flags(struct rpi_client *, struct ConfItem *);
void user_welcome(struct rpi_client *source_p);
 ...
 */
int
show_lusers(struct rpi_client *source_p)
{
 ...
 */
void
show_isupport(struct rpi_client *source_p)
{
...
int
register_local_user(struct rpi_client *client_p, struct rpi_client *source_p, const char *nick, const char *username)
{
	struct ConfItem *aconf;
	struct rpi_user *user = source_p->user;
 ...
 */
int
introduce_client(struct rpi_client *client_p, struct rpi_client *source_p, struct rpi_user *user, const char *nick)
{
	static char ubuf[12];
...
static void
report_and_set_user_flags(struct rpi_client *source_p, struct ConfItem *aconf)
{
 ...
 */
int
user_mode(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	int flag;
	int i;
	const char **p;
 ...
 */
void
send_umode(struct rpi_client *client_p, struct rpi_client *source_p, int old, int sendmask, char *umode_buf)
{
	int i;
	int flag;
	char *m;
 ...
 */
void
send_umode_out(struct rpi_client *client_p, struct rpi_client *source_p, int old)
{
	struct rpi_client *target_p;
	char buf[BUFSIZE];
	dlink_node *ptr;
 ...
 */
void
user_welcome(struct rpi_client *source_p)
{
 ...
 */
int
oper_up(struct rpi_client *source_p, struct oper_conf *oper_p)
{
