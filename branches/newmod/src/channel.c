 ...
 */
struct membership *
find_channel_membership(struct Channel *chptr, struct rpi_client *client_p)
{
 ...
 */
void
add_user_to_channel(struct Channel *chptr, struct rpi_client *client_p, int flags)
{
	struct membership *msptr;
 ...
 */
void
remove_user_from_channels(struct rpi_client *client_p)
{
	struct Channel *chptr;
	struct membership *msptr;
	dlink_node *ptr;
 ...
 */
void
channel_member_names(struct Channel *chptr, struct rpi_client *client_p, int show_eon)
{
	struct membership *msptr;
 ...
 */
void
del_invite(struct Channel *chptr, struct rpi_client *who)
{
 ...
 */
int
is_banned(struct Channel *chptr, struct rpi_client *who, struct membership *msptr,
 ...
 */
int
can_join(struct rpi_client *source_p, struct Channel *chptr, char *key)
{
	dlink_node *lp;
	dlink_node *ptr;
 ...
 */
int
can_send(struct Channel *chptr, struct rpi_client *source_p,
	 struct membership *msptr)
{
...
/* void check_spambot_warning(struct rpi_client *source_p)
 ...
 */
void
check_spambot_warning(struct rpi_client *source_p, const char *name)
{
	int t_delta;
	int decrement_count;
 ...
 */
void
channel_modes(struct Channel *chptr, struct rpi_client *client_p, char *mbuf, char *pbuf)
{
	int len;
	*mbuf++ = '+';
	*pbuf = '\0';
...
/* void set_chcap_usage_counts(struct rpi_client *serv_p)
 ...
 */
void
set_chcap_usage_counts(struct rpi_client *serv_p)
{
	int n;
 ...
 */
void
unset_chcap_usage_counts(struct rpi_client *serv_p)
{
	int n;
...
/* void send_cap_mode_changes(struct rpi_client *client_p,
 ...
 */
void
send_cap_mode_changes(struct rpi_client *client_p, struct rpi_client *source_p,
