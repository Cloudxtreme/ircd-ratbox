...
static int mr_pong(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_pong(struct rpi_client *, struct rpi_client *, int, const char **);
...
static int
ms_pong(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
...
static int
mr_pong(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
