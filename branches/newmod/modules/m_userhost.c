...
static int m_userhost(struct rpi_client *, struct rpi_client *, int, const char **);
 ...
 */
static int
m_userhost(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
