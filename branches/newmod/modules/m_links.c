...
static int m_links(struct rpi_client *, struct rpi_client *, int, const char **);
static int mo_links(struct rpi_client *, struct rpi_client *, int, const char **);
...
static void send_links_cache(struct rpi_client *source_p);
 ...
 */
static int
m_links(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
...
static int
mo_links(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	const char *mask = "";
 ...
 */
static void
send_links_cache(struct rpi_client *source_p)
{
	dlink_node *ptr;
