...
static int mo_resv(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_resv(struct rpi_client *, struct rpi_client *, int, const char **);
static int me_resv(struct rpi_client *, struct rpi_client *, int, const char **);
static int mo_unresv(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_unresv(struct rpi_client *, struct rpi_client *, int, const char **);
static int me_unresv(struct rpi_client *, struct rpi_client *, int, const char **);
...
static void parse_resv(struct rpi_client *source_p, const char *name,
			const char *reason, int temp_time);
static void propagate_resv(struct rpi_client *source_p, const char *target,
			int temp_time, const char *name, const char *reason);
static void cluster_resv(struct rpi_client *source_p, int temp_time, 
			const char *name, const char *reason);

static void handle_remote_unresv(struct rpi_client *source_p, const char *name);
static void remove_resv(struct rpi_client *source_p, const char *name);
static int remove_temp_resv(struct rpi_client *source_p, const char *name);
 ...
 */
static int
mo_resv(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	const char *name;
	const char *reason;
 ...
 */
static int
ms_resv(struct rpi_client *client_p, struct rpi_client *source_p,
...
static int
me_resv(struct rpi_client *client_p, struct rpi_client *source_p,
	int parc, const char *parv[])
{
	/* time name 0 :reason */
	if(!IsPerson(source_p))
 ...
 */
static void
parse_resv(struct rpi_client *source_p, const char *name, 
	   const char *reason, int temp_time)
{
...
static void 
propagate_resv(struct rpi_client *source_p, const char *target,
		int temp_time, const char *name, const char *reason)
{
	if(!temp_time)
	{
...
static void
cluster_resv(struct rpi_client *source_p, int temp_time, const char *name,
		const char *reason)
{
 ...
 */
static int
mo_unresv(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
 ...
 */
static int
ms_unresv(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
...
static int
me_unresv(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	/* name */
	if(!IsPerson(source_p))
		return 0;
...
static void
handle_remote_unresv(struct rpi_client *source_p, const char *name)
{
	if(!find_shared_conf(source_p->username, source_p->host,
...
static int
remove_temp_resv(struct rpi_client *source_p, const char *name)
{
	struct ConfItem *aconf;
 ...
 */
static void
remove_resv(struct rpi_client *source_p, const char *name)
{
	FBFILE *in, *out;
	char buf[BUFSIZE];
	char buff[BUFSIZE];
