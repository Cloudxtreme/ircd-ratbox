...
static int m_locops(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_locops(struct rpi_client *, struct rpi_client *, int, const char **);
static int me_locops(struct rpi_client *, struct rpi_client *, int, const char **);
 ...
 */
static int
m_locops(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
...
static int
ms_locops(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
...
static int
me_locops(struct rpi_client *client_p, struct rpi_client *source_p,
