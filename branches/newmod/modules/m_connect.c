...
static int mo_connect(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_connect(struct rpi_client *, struct rpi_client *, int, const char **);
 ...
 */
static int
mo_connect(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	int port;
	int tmpport;
 ...
 */
static int
ms_connect(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	int port;
	int tmpport;
	struct server_conf *server_p;
