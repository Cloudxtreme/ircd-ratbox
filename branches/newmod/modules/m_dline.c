...
static int mo_dline(struct rpi_client *, struct rpi_client *, int, const char **);
static int mo_undline(struct rpi_client *, struct rpi_client *, int, const char **);
...
static int flush_write(struct rpi_client *, FBFILE *, char *, char *);
 ...
 */
static int
mo_dline(struct rpi_client *client_p, struct rpi_client *source_p,
 ...
 */
static int
mo_undline(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	FBFILE *in;
	FBFILE *out;
 ...
 */
static int
flush_write(struct rpi_client *source_p, FBFILE * out, char *buf, char *temppath)
{
