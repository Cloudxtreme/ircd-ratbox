...
static int mo_kline(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_kline(struct rpi_client *, struct rpi_client *, int, const char **);
static int me_kline(struct rpi_client *, struct rpi_client *, int, const char **);
static int mo_unkline(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_unkline(struct rpi_client *, struct rpi_client *, int, const char **);
static int me_unkline(struct rpi_client *, struct rpi_client *, int, const char **);
...
static int find_user_host(struct rpi_client *source_p, const char *userhost, char *user, char *host);
static int valid_comment(struct rpi_client *source_p, char *comment);
static int valid_user_host(struct rpi_client *source_p, const char *user, const char *host);
static int valid_wild_card(struct rpi_client *source_p, const char *user, const char *host);

static void handle_remote_kline(struct rpi_client *source_p, int tkline_time,
		const char *user, const char *host, const char *reason);
static void apply_kline(struct rpi_client *source_p, struct ConfItem *aconf,
			const char *reason, const char *oper_reason, const char *current_date);
static void apply_tkline(struct rpi_client *source_p, struct ConfItem *aconf,
			 const char *, const char *, const char *, int);
static int already_placed_kline(struct rpi_client *, const char *, const char *, int);

static void handle_remote_unkline(struct rpi_client *source_p, 
			const char *user, const char *host);
static void remove_permkline_match(struct rpi_client *, const char *, const char *);
static int flush_write(struct rpi_client *, FBFILE *, const char *, const char *);
 ...
 */
static int
mo_kline(struct rpi_client *client_p, struct rpi_client *source_p,
 ...
 */
static int
ms_kline(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
...
static int
me_kline(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	/* <tkline_time> <user> <host> :<reason> */
	if(!IsPerson(source_p))
		return 0;
...
static void
handle_remote_kline(struct rpi_client *source_p, int tkline_time,
 ...
 */
static int
mo_unkline(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	const char *user;
	char *host;
	char splat[] = "*";
 ...
 */
static int
ms_unkline(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
...
static int
me_unkline(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	/* user host */
	if(!IsPerson(source_p))
		return 0;
...
static void
handle_remote_unkline(struct rpi_client *source_p, const char *user, const char *host)
{
	if(!find_shared_conf(source_p->username, source_p->host,
 ...
 */
static void
apply_kline(struct rpi_client *source_p, struct ConfItem *aconf,
	    const char *reason, const char *oper_reason, const char *current_date)
{
 ...
 */
static void
apply_tkline(struct rpi_client *source_p, struct ConfItem *aconf,
 ...
 */
static int
find_user_host(struct rpi_client *source_p, const char *userhost, char *luser, char *lhost)
{
	char *hostp;
 ...
 */
static int
valid_user_host(struct rpi_client *source_p, const char *luser, const char *lhost)
{
 ...
 */
static int
valid_wild_card(struct rpi_client *source_p, const char *luser, const char *lhost)
{
	const char *p;
	char tmpch;
	int nonwild = 0;
 ...
 */
static int
valid_comment(struct rpi_client *source_p, char *comment)
{
	if(strchr(comment, '"'))
	{
 ...
 */
static int
already_placed_kline(struct rpi_client *source_p, const char *luser, const char *lhost, int tkline)
{
	const char *reason;
 ...
 */
static void
remove_permkline_match(struct rpi_client *source_p, const char *host, const char *user)
{
	FBFILE *in, *out;
	int pairme = 0;
...
static int
flush_write(struct rpi_client *source_p, FBFILE * out, const char *buf, const char *temppath)
{
