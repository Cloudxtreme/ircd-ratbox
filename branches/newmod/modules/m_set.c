...
static int mo_set(struct rpi_client *, struct rpi_client *, int, const char **);
...
static void quote_adminstring(struct rpi_client *, const char *);
static void quote_autoconn(struct rpi_client *, char *, int);
static void quote_autoconnall(struct rpi_client *, int);
static void quote_floodcount(struct rpi_client *, int);
static void quote_identtimeout(struct rpi_client *, int);
static void quote_idletime(struct rpi_client *, int);
static void quote_max(struct rpi_client *, int);
static void quote_operstring(struct rpi_client *, const char *);
static void quote_spamnum(struct rpi_client *, int);
static void quote_spamtime(struct rpi_client *, int);
static void quote_splitmode(struct rpi_client *, char *);
static void quote_splitnum(struct rpi_client *, int);
static void quote_splitusers(struct rpi_client *, int);
static void quote_splitdelay(struct rpi_client *, int);
static void list_quote_commands(struct rpi_client *);
 ...
 */
static void
list_quote_commands(struct rpi_client *source_p)
{
	int i;
	int j = 0;
	const char *names[4];
...
/* SET AUTOCONN */
static void
quote_autoconn(struct rpi_client *source_p, char *arg, int newval)
{
...
/* SET AUTOCONNALL */
static void
quote_autoconnall(struct rpi_client *source_p, int newval)
{
	if(newval >= 0)
	{
...
/* SET FLOODCOUNT */
static void
quote_floodcount(struct rpi_client *source_p, int newval)
{
	if(newval >= 0)
	{
...
/* SET IDENTTIMEOUT */
static void
quote_identtimeout(struct rpi_client *source_p, int newval)
{
...
/* SET IDLETIME */
static void
quote_idletime(struct rpi_client *source_p, int newval)
{
	if(newval >= 0)
	{
		if(newval == 0)
...
/* SET MAX */
static void
quote_max(struct rpi_client *source_p, int newval)
{
	if(newval > 0)
	{
...
/* SET OPERSTRING */
static void
quote_operstring(struct rpi_client *source_p, const char *arg)
{
	if(EmptyString(arg))
	{
...
/* SET ADMINSTRING */
static void
quote_adminstring(struct rpi_client *source_p, const char *arg)
{
	if(EmptyString(arg))
	{
...
/* SET SPAMNUM */
static void
quote_spamnum(struct rpi_client *source_p, int newval)
{
	if(newval > 0)
	{
		if(newval == 0)
...
/* SET SPAMTIME */
static void
quote_spamtime(struct rpi_client *source_p, int newval)
{
	if(newval > 0)
	{
...
/* SET SPLITMODE */
static void
quote_splitmode(struct rpi_client *source_p, char *charval)
{
	if(charval)
	{
		int newval;
...
/* SET SPLITNUM */
static void
quote_splitnum(struct rpi_client *source_p, int newval)
{
	if(newval >= 0)
	{
		sendto_realops_flags(UMODE_ALL, L_ALL,
...
/* SET SPLITUSERS */
static void
quote_splitusers(struct rpi_client *source_p, int newval)
{
	if(newval >= 0)
	{
		sendto_realops_flags(UMODE_ALL, L_ALL,
...
/* SET SPLITDELAY */
static void
quote_splitdelay(struct rpi_client *source_p, int newval)
{
	if(newval >= 0)
	{
		sendto_realops_flags(UMODE_ALL, L_ALL,
 ...
 */
static int
mo_set(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	int newval;
	int i, n;
	const char *arg = NULL;
