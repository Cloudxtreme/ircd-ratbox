...
static int mr_user(struct rpi_client *, struct rpi_client *, int, const char **);
...
static int do_local_user(struct rpi_client *client_p, struct rpi_client *source_p,
 ...
 */
static int
mr_user(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	char *p;
...
static int
do_local_user(struct rpi_client *client_p, struct rpi_client *source_p,
	      const char *username, const char *realname)
{
