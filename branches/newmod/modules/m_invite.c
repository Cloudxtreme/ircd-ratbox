...
static int m_invite(struct rpi_client *, struct rpi_client *, int, const char **);
...
static void add_invite(struct Channel *, struct rpi_client *);
 ...
 */
static int
m_invite(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
 ...
 */
static void
add_invite(struct Channel *chptr, struct rpi_client *who)
{
	dlink_node *ptr;
