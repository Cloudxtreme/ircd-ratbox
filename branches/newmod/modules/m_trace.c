...
static int m_trace(struct rpi_client *, struct rpi_client *, int, const char **);

static void trace_spy(struct rpi_client *, const char *);
...
static int report_this_status(struct rpi_client *source_p, struct rpi_client *target_p, int dow,
 ...
 */
static int
m_trace(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
 ...
 */
static int
report_this_status(struct rpi_client *source_p, struct rpi_client *target_p,
		   int dow, int link_u_p, int link_s_p)
{
	...
	if(IsAnyServer(target_p))
		name = target_p->v->server_name(target_p, HIDE_IP);
	else
		name = target_p->v->get_name(target_p, HIDE_IP);
 ...
 */
static void
trace_spy(struct rpi_client *source_p, const char *target)
{
