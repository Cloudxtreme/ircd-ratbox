...
static int m_join(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_join(struct rpi_client *, struct rpi_client *, int, const char **);
...
static void do_join_0(struct rpi_client *client_p, struct rpi_client *source_p);

static void set_final_mode(struct Mode *mode, struct Mode *oldmode);
static void remove_our_modes(struct Channel *chptr, struct rpi_client *source_p);
 ...
 */
static int
m_join(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
 ...
 */
static int
ms_join(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
 ...
 */
static void
do_join_0(struct rpi_client *client_p, struct rpi_client *source_p)
{
 ...
 */
static void
remove_our_modes(struct Channel *chptr, struct rpi_client *source_p)
{
	struct membership *msptr;
	dlink_node *ptr;
