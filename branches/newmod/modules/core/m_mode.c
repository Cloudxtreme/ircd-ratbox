...
static int m_mode(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_mode(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_tmode(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_bmask(struct rpi_client *, struct rpi_client *, int, const char **);
...
static void set_channel_mode(struct rpi_client *, struct rpi_client *,
			     struct Channel *, struct membership *,
			     int, const char **);

static int add_id(struct rpi_client *source_p, struct Channel *chptr, 
...
static void
loc_channel_modes(struct Channel *chptr, struct rpi_client *client_p, char *mbuf, char *pbuf)
{
	int len;
	*mbuf++ = '+';
	*pbuf = '\0';
 ...
 */
static int
m_mode(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
...
static int
ms_mode(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
...
static int
ms_tmode(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	struct Channel *chptr = NULL;
	struct membership *msptr;
...
static int
ms_bmask(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	static char modebuf[BUFSIZE];
	static char parabuf[BUFSIZE];
	struct Channel *chptr;
 ...
 */
static int
add_id(struct rpi_client *source_p, struct Channel *chptr, const char *banid,
 ...
 */
static void
chm_nosuch(struct rpi_client *source_p, struct Channel *chptr, 
...
static void
chm_simple(struct rpi_client *source_p, struct Channel *chptr, 
	   int alevel, int parc, int *parn,
	   const char **parv, int *errors, int dir, char c, long mode_type)
{
...
static void
chm_ban(struct rpi_client *source_p, struct Channel *chptr, 
	int alevel, int parc, int *parn,
	const char **parv, int *errors, int dir, char c, long mode_type)
{
	const char *mask;
...
static void
chm_op(struct rpi_client *source_p, struct Channel *chptr, 
       int alevel, int parc, int *parn,
       const char **parv, int *errors, int dir, char c, long mode_type)
{
	struct membership *mstptr;
	const char *opnick;
	struct rpi_client *targ_p;
...
static void
chm_voice(struct rpi_client *source_p, struct Channel *chptr,
	  int alevel, int parc, int *parn,
	  const char **parv, int *errors, int dir, char c, long mode_type)
{
	struct membership *mstptr;
...
static void
chm_limit(struct rpi_client *source_p, struct Channel *chptr,
	  int alevel, int parc, int *parn,
	  const char **parv, int *errors, int dir, char c, long mode_type)
{
	const char *lstr;
...
static void
chm_key(struct rpi_client *source_p, struct Channel *chptr,
	int alevel, int parc, int *parn,
	const char **parv, int *errors, int dir, char c, long mode_type)
{
	char *key;
...
struct ChannelMode
{
	void (*func) (struct rpi_client *source_p, struct Channel *chptr,
		      int alevel, int parc, int *parn, 
...
static int
get_channel_access(struct rpi_client *source_p, struct membership *msptr)
{
 ...
 */
void
set_channel_mode(struct rpi_client *client_p, struct rpi_client *source_p,
