...
static int ms_sjoin(struct rpi_client *, struct rpi_client *, int, const char **);
...
static void remove_ban_list(struct Channel *chptr, struct rpi_client *source_p,
			    dlink_list *list, char c, int cap);

static int
ms_sjoin(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
 ...
 */
static void
remove_ban_list(struct Channel *chptr, struct rpi_client *source_p,
		dlink_list *list, char c, int cap)
{
