...
static int ms_kill(struct rpi_client *, struct rpi_client *, int, const char **);
static int mo_kill(struct rpi_client *, struct rpi_client *, int, const char **);
static void relay_kill(struct rpi_client *, struct rpi_client *, struct rpi_client *,
...
*/
static int
mo_kill(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
 ...
 */
static int
ms_kill(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	struct rpi_client *target_p;
	const char *user;
	const char *reason;
...
static void
relay_kill(struct rpi_client *one, struct rpi_client *source_p,
	   struct rpi_client *target_p, const char *inpath, const char *reason)
{
