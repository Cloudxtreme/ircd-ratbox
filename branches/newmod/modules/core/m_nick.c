...
static int mr_nick(struct rpi_client *, struct rpi_client *, int, const char **);
static int m_nick(struct rpi_client *, struct rpi_client *, int, const char **);
static int mc_nick(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_nick(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_uid(struct rpi_client *, struct rpi_client *, int, const char **);
...
static int change_remote_nick(struct rpi_client *, struct rpi_client *, int, const char **, time_t, const char *);
...
static void set_initial_nick(struct rpi_client *client_p, struct rpi_client *source_p, char *nick);
static void change_local_nick(struct rpi_client *client_p, struct rpi_client *source_p, char *nick);
static int register_client(struct rpi_client *client_p, struct rpi_client *server,
			   const char *nick, time_t newts, int parc, const char *parv[]);

static int perform_nick_collides(struct rpi_client *, struct rpi_client *,
				 struct rpi_client *, int, const char **,
				 time_t, const char *, const char *);
static int perform_nickchange_collides(struct rpi_client *, struct rpi_client *,
				       struct rpi_client *, int, const char **,
				       time_t, const char *);
 ...
 */
static int
mr_nick(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
 ...
 */
static int
m_nick(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	struct rpi_client *target_p;
	char nick[NICKLEN];
	char *s;
 ...
 */
static int
mc_nick(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	struct rpi_client *target_p;
	time_t newts = 0;
...
static int
ms_nick(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	struct rpi_client *target_p;
	time_t newts = 0;
 ...
 */
static int
ms_uid(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	struct rpi_client *target_p;
	time_t newts = 0;
...
static void
set_initial_nick(struct rpi_client *client_p, struct rpi_client *source_p, char *nick)
{
	char buf[USERLEN + 1];
...
static void
change_local_nick(struct rpi_client *client_p, struct rpi_client *source_p, char *nick)
{
	source_p->tsinfo = CurrentTime;
 ...
 */
static int
change_remote_nick(struct rpi_client *client_p, struct rpi_client *source_p, int parc,
...
static int
perform_nick_collides(struct rpi_client *source_p, struct rpi_client *client_p,
		      struct rpi_client *target_p, int parc, const char *parv[],
...
static int
perform_nickchange_collides(struct rpi_client *source_p, struct rpi_client *client_p,
			    struct rpi_client *target_p, int parc,
			    const char *parv[], time_t newts, const char *nick)
{
	int sameuser;
...
static int
register_client(struct rpi_client *client_p, struct rpi_client *server,
		const char *nick, time_t newts, int parc, const char *parv[])
{
	...
	source_p = new("client", 0, client_p);
	...
	{
		struct rpi_client *target_p = source_p->servptr->from;
