...
static int m_quit(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_quit(struct rpi_client *, struct rpi_client *, int, const char **);
...
*/
static int
m_quit(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
...
*/
static int
ms_quit(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	char *comment = LOCAL_COPY((parc > 1 && parv[1]) ? parv[1] : client_p->name);
