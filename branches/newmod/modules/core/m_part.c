...
static int m_part(struct rpi_client *, struct rpi_client *, int, const char **);
...
static void part_one_client(struct rpi_client *client_p,
			    struct rpi_client *source_p, char *name, char *reason);
...
*/
static int
m_part(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	char *p, *name;
 ...
 */
static void
part_one_client(struct rpi_client *client_p, struct rpi_client *source_p, char *name, char *reason)
{
