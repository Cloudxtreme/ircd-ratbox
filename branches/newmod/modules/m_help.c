...
static int m_help(struct rpi_client *, struct rpi_client *, int, const char **);
static int mo_help(struct rpi_client *, struct rpi_client *, int, const char **);
static int mo_uhelp(struct rpi_client *, struct rpi_client *, int, const char **);
static void dohelp(struct rpi_client *, int, const char *);
 ...
 */
static int
m_help(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
 ...
 */
static int
mo_help(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
 ...
 */
static int
mo_uhelp(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	dohelp(source_p, HELP_USER, parc > 1 ? parv[1] : NULL);
	return 0;
}
...
static void
dohelp(struct rpi_client *source_p, int flags, const char *topic)
{
