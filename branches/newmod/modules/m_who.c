...
static int m_who(struct rpi_client *, struct rpi_client *, int, const char **);
...
static void do_who_on_channel(struct rpi_client *source_p, struct Channel *chptr,
			      int server_oper, int member);

static void who_global(struct rpi_client *source_p, const char *mask, int server_oper, int operspy);

static void do_who(struct rpi_client *source_p,
		   struct rpi_client *target_p, const char *chname, const char *op_flags);
...
*/
static int
m_who(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
 ...
 */
static void
who_common_channel(struct rpi_client *source_p, struct Channel *chptr,
 ...
 */
static void
who_global(struct rpi_client *source_p, const char *mask, int server_oper, int operspy)
{
	struct membership *msptr;
	struct rpi_client *target_p;
	dlink_node *lp, *ptr;
 ...
 */
static void
do_who_on_channel(struct rpi_client *source_p, struct Channel *chptr,
		  int server_oper, int member)
{
	struct rpi_client *target_p;
	struct membership *msptr;
...
static void
do_who(struct rpi_client *source_p, struct rpi_client *target_p, const char *chname, const char *op_flags)
{
	char status[5];
