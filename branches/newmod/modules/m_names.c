...
static int m_names(struct rpi_client *, struct rpi_client *, int, const char **);
...
static void names_global(struct rpi_client *source_p);
 ...
 */
static int
m_names(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
 ...
 */
static void
names_global(struct rpi_client *source_p)
{
	int mlen;
	int tlen;
	int cur_len;
