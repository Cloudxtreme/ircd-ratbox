...
static int mr_capab(struct rpi_client *, struct rpi_client *, int, const char **);
static int me_gcap(struct rpi_client *, struct rpi_client *, int, const char **);
 ...
 */
static int
mr_capab(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
...
static int
me_gcap(struct rpi_client *client_p, struct rpi_client *source_p,
