...
static int m_whowas(struct rpi_client *, struct rpi_client *, int, const char **);
...
*/
static int
m_whowas(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{	
	struct Whowas *temp;
	int cur = 0;
	int max = -1, found = 0;
