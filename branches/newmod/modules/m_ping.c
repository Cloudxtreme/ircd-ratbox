...
static int m_ping(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_ping(struct rpi_client *, struct rpi_client *, int, const char **);
...
*/
static int
m_ping(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
...
static int
ms_ping(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	struct rpi_client *target_p;
	const char *destination;
