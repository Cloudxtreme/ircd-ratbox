...
static int mo_gline(struct rpi_client *, struct rpi_client *, int, const char **);
static int mc_gline(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_gline(struct rpi_client *, struct rpi_client *, int, const char **);
static int mo_ungline(struct rpi_client *, struct rpi_client *, int, const char **);
...
static int majority_gline(struct rpi_client *source_p, const char *user,
			  const char *host, const char *reason);
static void set_local_gline(struct rpi_client *source_p, const char *user,
			    const char *host, const char *reason);

static int check_wild_gline(const char *, const char *);
static int invalid_gline(struct rpi_client *, const char *, const char *, char *);
 ...
 */
static int
mo_gline(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
 ...
 */
static int
mc_gline(struct rpi_client *client_p, struct rpi_client *source_p,
	 int parc, const char *parv[])
{
	struct rpi_client *acptr;
	const char *user;
	const char *host;
	char *reason;
	char *ptr;
 ...
 */
static int
ms_gline(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	struct rpi_client *acptr;
	const char *user;
	const char *host;
 ...
 */
static int
mo_ungline(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	const char *user;
 ...
 */
static int
invalid_gline(struct rpi_client *source_p, const char *luser,
 ...
 */
static void
set_local_gline(struct rpi_client *source_p, const char *user,
		const char *host, const char *reason)
{
 ...
 */
static int
majority_gline(struct rpi_client *source_p, const char *user,
	       const char *host, const char *reason)
{
