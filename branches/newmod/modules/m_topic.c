...
static int m_topic(struct rpi_client *, struct rpi_client *, int, const char **);
static int ms_topic(struct rpi_client *, struct rpi_client *, int, const char **);
 ...
 */
static int
m_topic(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
 ...
 */
static int
ms_topic(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	struct Channel *chptr = NULL;
