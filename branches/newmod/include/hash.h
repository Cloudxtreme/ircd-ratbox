...
extern void add_to_client_hash(const char *name, struct rpi_client *client);
extern void del_from_client_hash(const char *name, struct rpi_client *client);
extern struct rpi_client *find_any_client(const char *name);
extern struct rpi_client *find_client(const char *name);
extern struct rpi_client *find_named_client(const char *name);
extern struct rpi_client *find_server(struct rpi_client *source_p, const char *name);

extern void add_to_id_hash(const char *, struct rpi_client *);
extern void del_from_id_hash(const char *name, struct rpi_client *client);
extern struct rpi_client *find_id(const char *name);

extern struct Channel *get_or_create_channel(struct rpi_client *client_p, const char *chname, int *isnew);
extern void del_from_channel_hash(const char *name, struct Channel *chan);
extern struct Channel *find_channel(const char *name);

extern void add_to_hostname_hash(const char *, struct rpi_client *);
extern void del_from_hostname_hash(const char *, struct rpi_client *);
...
extern void print_resv_hash(struct rpi_client *source_p);
...
extern void hash_stats(struct rpi_client *);
