...
extern int zip_init(struct rpi_client *);
extern void zip_free(struct rpi_client *);
extern char *unzip_packet(struct rpi_client *, char *, int *);
extern char *zip_buffer(struct rpi_client *, char *, int *, int);
