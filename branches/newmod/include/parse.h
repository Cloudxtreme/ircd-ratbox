...
extern void parse(struct rpi_client *, char *, char *);
extern void handle_encap(struct rpi_client *, struct rpi_client *,
...
extern void report_messages(struct rpi_client *);
