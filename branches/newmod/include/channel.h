...
extern int can_send(struct Channel *chptr, struct rpi_client *who,
		    struct membership *);
extern int is_banned(struct Channel *chptr, struct rpi_client *who,
		     struct membership *msptr, const char *, const char *);
extern int can_join(struct rpi_client *source_p, struct Channel *chptr, char *key);

extern struct membership *find_channel_membership(struct Channel *, struct rpi_client *);
extern const char *find_channel_status(struct membership *msptr, int combine);
extern void add_user_to_channel(struct Channel *, struct rpi_client *, int flags);
extern void remove_user_from_channel(struct membership *);
extern void remove_user_from_channels(struct rpi_client *);

extern void free_channel_list(dlink_list *);

extern int check_channel_name(const char *name);

extern void channel_member_names(struct Channel *chptr, struct rpi_client *,
				 int show_eon);

extern void del_invite(struct Channel *chptr, struct rpi_client *who);

extern void channel_modes(struct Channel *chptr, struct rpi_client *who, char *, char *);

extern void check_spambot_warning(struct rpi_client *source_p, const char *name);
...
extern void set_chcap_usage_counts(struct rpi_client *serv_p);
extern void unset_chcap_usage_counts(struct rpi_client *serv_p);
extern void send_cap_mode_changes(struct rpi_client *client_p, struct rpi_client *source_p,
