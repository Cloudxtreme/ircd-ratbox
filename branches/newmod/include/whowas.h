...
struct Whowas
{
	...
	time_t logoff;
	struct rpi_client *online;	/* Pointer to new nickname for chasing or NULL */
...
*/
void add_history(struct rpi_client *, int);
...
*/
void off_history(struct rpi_client *);
...
**      one found...
*/
struct rpi_client *get_history(const char *, time_t);
					/* Nick name */
