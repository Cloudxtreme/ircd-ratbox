...
extern int attach_conf(struct rpi_client *, struct ConfItem *);
extern int check_client(struct rpi_client *client_p, struct rpi_client *source_p, const char *);

extern int detach_conf(struct rpi_client *);
...
extern char *show_iline_prefix(struct rpi_client *, struct ConfItem *, char *);
extern void get_printable_conf(struct ConfItem *,
			       char **, char **, char **, char **, int *, char **);
extern void get_printable_kline(struct rpi_client *, struct ConfItem *,
				char **, char **, char **, char **);
...
extern void write_confitem(KlineType, struct rpi_client *, char *, char *,
			   const char *, const char *, const char *, int);
extern void add_temp_kline(struct ConfItem *);
extern void add_temp_dline(struct ConfItem *);
extern void report_temp_klines(struct rpi_client *);
extern void show_temp_klines(struct rpi_client *, dlink_list *);
...
extern char *get_oper_name(struct rpi_client *client_p);
