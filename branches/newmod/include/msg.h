...
/* struct rpi_client* client_p   - connection message originated from
 * struct rpi_client* source_p   - source of message, may be different from client_p
 * int            parc   - parameter count
 * char*          parv[] - parameter vector
 */
typedef int (*MessageHandler) (rpi_client *, rpi_client *, int, const char *[]);
...
/* generic handlers */
extern int m_ignore			(rpi_client *, rpi_client *, int, const char **);
extern int m_not_oper		(rpi_client *, rpi_client *, int, const char **);
extern int m_registered		(rpi_client *, rpi_client *, int, const char **);
extern int m_unregistered	(rpi_client *, rpi_client *, int, const char **);
 ...
 * int m_func(struct rpi_client* client_p, struct rpi_client* source_p, int parc, char* parv[]);
 *
