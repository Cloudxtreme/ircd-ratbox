...
static int mo_clearchan(struct rpi_client *client_p, struct rpi_client *source_p,
...
*/
static int
mo_clearchan(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
