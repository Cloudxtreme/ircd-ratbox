...
static int mo_okick(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[]);
...
*/
static int
mo_okick(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
