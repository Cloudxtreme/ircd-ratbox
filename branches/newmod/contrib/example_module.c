...
static int munreg_test(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[]);
static int mclient_test(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[]);
static int mserver_test(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[]);
static int mrclient_test(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[]);
static int moper_test(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[]);
 ...
 */
static int
munreg_test(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	if(parc < 2)
	{
 ...
 */
static int
mclient_test(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	if(parc < 2)
	{
 ...
 */
static int
mrclient_test(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	if(parc < 2)
	{
		sendto_one(source_p,
 ...
 */
static int
mserver_test(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	if(parc < 2)
	{
		sendto_one(source_p,
 ...
 */
static int
moper_test(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	if(parc < 2)
	{
