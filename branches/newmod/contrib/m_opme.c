...
static int mo_opme(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[]);
...
*/
static int
mo_opme(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
