...
static int m_mkpasswd(struct rpi_client *client_p, struct rpi_client *source_p,
		      int parc, const char *parv[]);
static int mo_mkpasswd(struct rpi_client *client_p, struct rpi_client *source_p,
		       int parc, const char *parv[]);
...
static int
m_mkpasswd(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
...
*/
static int
mo_mkpasswd(struct rpi_client *client_p, struct rpi_client *source_p, int parc, const char *parv[])
{
	int is_md5 = 0;
